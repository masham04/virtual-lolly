            ...
            <div className="container-main">
                        ...
                        <g id="Page-2" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                            <g id="Lolly">
                                ...
                                <use className="lollyBottom"
                                    fill={pageContext.flavorBot}
                                    fillRule="nonzero"
                                    xlinkHref="#path-1" />
                                <rect
                                    className="lollyTop"
                                    fill={pageContext.flavorTop}
                                    fillRule="nonzero"
                                    mask="url(#mask-2)"
                                    x={-25}
                                    y={-9}
                ...
                <div>
                    ...
                    <div className="details">
                        <h5 className="reciever">To: {pageContext.recipientName}</h5>
                        <h5 className="message">Message: {pageContext.message}</h5>
                        <h5 className="from">From: {pageContext.sendersName}</h5>
                    </div>
